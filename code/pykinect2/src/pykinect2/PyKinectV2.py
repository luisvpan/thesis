...
# Fix for Python 3.12+ and 64-bit systems
# Original: required_size = 64 + sysinfo.platform_bits / 4
# On 64-bit: sizeof(tagSTATSTG) is 80, not 72
is_64bits = sys.maxsize > 2**32
required_size = 80 if is_64bits else 72

# Commented out assert - size varies by platform/compiler
...
# Commented out for Python 3.12+ compatibility
