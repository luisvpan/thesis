...
def calibrar_mesa_y_detectar_toques(device):
    ...
    area_calibrada = (xw_min, yw_min_escalado, xw_max_escalado - xw_min, yw_max - yw_min_escalado)
    print(area_calibrada)
    dmax_map = calculate_dmax(device, area_calibrada, xv_min, yv_min, xv_max, yv_max)
    ...
    if 'xw_min' in locals():
        ...
        if event == 'Sí':
            ...
            while True:
                ...
                depth_roi = depth_data[y:y+h, y:y+w]
