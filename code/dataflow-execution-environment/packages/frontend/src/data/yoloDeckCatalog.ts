...
export type DeckSectionId = 'numbers' | 'operators' | 'figures' | 'foods' | 'montessori';
...
export const DECK_SECTION_ITEMS: Record<DeckSectionId, readonly string[]> = {
  ...
  figures: ['sm_circle', 'sm_square', 'sm_triangle', 'md_circle', 'md_square', 'md_triangle', 'lg_circle', 'lg_square', 'lg_triangle', 'green', 'purple', 'red'],
