...
export type SourceCardCategory =
  | Extract<CardCategory, 'number' | 'shape' | 'montessori' | 'cap' | 'stick' | 'food' | 'dice'>
  | 'criteria';
...
const DICE_WRAPPER = 'relative flex w-52 -translate-x-[30%] -translate-y-[55%] flex-col items-center';
