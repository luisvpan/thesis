...
export const Add = createToken({ name: "Add", pattern: /ADD/i });
export const Subtract = createToken({ name: "Subtract", pattern: /SUBTRACT/i });
export const Multiply = createToken({ name: "Multiply", pattern: /MULTIPLY/i });
export const Divide = createToken({ name: "Divide", pattern: /DIVIDE/i });
export const Compare = createToken({ name: "Compare", pattern: /COMPARE/i });
export const Filter = createToken({ name: "Filter", pattern: /FILTER/i });
export const Union = createToken({ name: "Union", pattern: /UNION/i });
export const Intersection = createToken({ name: "Intersection", pattern: /INTERSECTION/i });
export const Difference = createToken({ name: "Difference", pattern: /DIFFERENCE/i });
export const Complement = createToken({ name: "Complement", pattern: /COMPLEMENT/i });
export const Next = createToken({ name: "Next", pattern: /NEXT/i });
export const First = createToken({ name: "First", pattern: /FIRST/i });
export const Fby = createToken({ name: "Fby", pattern: /FBY/i });
export const Accumulate = createToken({ name: "Accumulate", pattern: /ACCUMULATE/i });
